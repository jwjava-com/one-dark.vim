...
call SetColor('DiffAdd', {'fg': s:mono_1, 'bg': '#4d664f'})
call SetColor('DiffChange', {'fg': s:mono_1, 'bg': '#4d664f'})
call SetColor('DiffDelete', {'fg': '#e45d5c', 'bg': 'NONE', 'style': 'none'})
call SetColor('DiffText', {'fg': s:mono_1, 'bg': '#284329', 'style': 'none'})
...
call SetColor('JsonBoolean', {'fg': s:cyan})
...
call SetColor('SpellCap', {'sp': s:orange_2})
...
call SetColor('SyntasticWarningSign', {'fg': s:orange_2, 'style': 'bold'})
call SetColor('SyntasticStyleWarningSign', {'fg': s:orange_2, 'style': 'bold'})
